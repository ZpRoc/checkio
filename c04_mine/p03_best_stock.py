...
# You are given the current stock prices. You have to find out which 
# stocks cost more.

# Input: The dictionary where the market identifier code is a key and 
#        the value is a stock price.
