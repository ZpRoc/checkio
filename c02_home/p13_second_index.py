...
# first occurrence with a function index or find which will point 
# out that "s" is the first symbol in a word "sims" and therefore 
# the index of the first occurrence is 0. But we have to find the 
# second "s" which is 4th in a row and that means that the index 
...
def second_index(text: str, symbol: str) -> [int, None]:
    ...
    index2 = text.find(symbol, index1 + 1)
